      ...
      <div className="mx-auto max-w-sm text-center">
        ...
        <div className="mt-8 space-y-3">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-full bg-login-bg py-3 text-sm font-bold text-login-text transition-transform hover:scale-105 active:scale-100"
          >
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-full bg-accent py-3 text-sm font-bold text-text-inverse transition-transform hover:bg-accent-hover hover:scale-105 active:scale-100"
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
